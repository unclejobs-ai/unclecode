...
test("runtime QA stays split into inspectable modules", () => {
  ...
  assert.deepEqual(moduleFiles, [
    ...
    "runtime-memory-soak-fixtures.mjs",
    "runtime-memory-soak-workloads.mjs",
    "runtime-memory-soak.mjs",
    "runtime-owner-cleanup.mjs",
    "runtime-owner-client-fixture.mjs",
    "runtime-owner-fixture.mjs",
    "runtime-owner-tui-smoke.mjs",
    "tmux-helpers.mjs",
    "tty-smoke.mjs",
