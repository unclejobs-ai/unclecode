...
test("reduceShellEvent appends completed activity entries and refreshes home state", () => {
  ...
  const next = reduceShellEvent(running, {
    ...
    entry: {
      id: "research-1",
      source: "new-research",
      title: "Context: summarize repo",
      lines: ["Work context refreshed", "Saved locally: /tmp/research.md"],
      tone: "success",
    },
    outputLines: ["Work context refreshed", "Saved locally: /tmp/research.md"],
    homeState: {
      ...baseHomeState,
      modeLabel: "analyze",
      sessionCount: 2,
      ...
      sessions: [
        {
          ...
          taskSummary: "Refreshed Work context",
        },
