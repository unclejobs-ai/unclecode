...
/**
 * Pure-TS display-width wrap for hot render paths (streaming frames) where
 * the synchronous Rust wrap spawn is too slow to run per delta. Greedy word
 * wrap; words wider than the line fall back to grapheme splitting so CJK
