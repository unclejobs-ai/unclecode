...
Prefer narrow edits over refactors. Stop as soon as the regression test passes.`,
    ...
    allowedTools: ["read_file", "write_file", "delete_file", "search_text", "list_files", "run_shell"],
  },
  builder: {
    persona: "builder",
    systemPrompt: `${SHARED_INSTRUCTIONS}
...
Bias toward minimum-surface patches. Prefer explicit denylist + audit log over silent fixes.`,
    ...
    costLimitUsd: 1.5,
    submitMarker: DEFAULT_SUBMIT_MARKER,
    allowedTools: ["read_file", "write_file", "delete_file", "search_text", "list_files"],
  },
  auditor: {
    persona: "auditor",
    systemPrompt: `${SHARED_INSTRUCTIONS}
...
No iterative loop. Localize then propose patches and submit.`,
    ...
    costLimitUsd: 0.2,
    submitMarker: DEFAULT_SUBMIT_MARKER,
    allowedTools: ["read_file", "search_text", "list_files", "write_file", "delete_file"],
  },
