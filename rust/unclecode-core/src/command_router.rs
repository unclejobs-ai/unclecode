...
const CLI_SLASH_COMMANDS: &[BuiltinSlashCommand] = &[
    ...
    BuiltinSlashCommand {
        ...
        description: "Show research-mode status.",
        aliases: &[],
    },
    BuiltinSlashCommand {
        command: "/mcp list",
...
const WORK_SHELL_SLASH_COMMANDS: &[BuiltinSlashCommand] = &[
    ...
    BuiltinSlashCommand {
        command: "/research",
        route: &["research", "run"],
        description: "Run a local research pass for the given topic or workspace question.",
        aliases: &[],
    },
    BuiltinSlashCommand {
        command: "/research status",
        route: &["research", "status"],
        description: "Show the latest local research status.",
        aliases: &[],
    },
    BuiltinSlashCommand {
        command: "/review",
